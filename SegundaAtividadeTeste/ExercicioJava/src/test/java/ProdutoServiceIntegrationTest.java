...
public class ProdutoServiceIntegrationTest {
    ...
    void testAtualizarProduto_Sucesso() throws Exception {
        // ARRANGE
        Produto produtoOriginal = produtoService.cadastrarProduto(new Produto("Gabinete ATX", 350.00, 4, "Hardware"));
    ...
    void testExcluirProduto_Sucesso() throws Exception {
        ...
        Exception exception = assertThrows(Exception.class, () -> {
            produtoService.buscarPorId(idParaExcluir);
        });
        assertEquals("Produto não existe no banco de dados", exception.getMessage());
    }
